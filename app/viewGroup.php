...
<nav class="bg-gradient-to-r from-green-600 to-green-700 text-white p-4 shadow-lg">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <a href="manageGroups.php" class="bg-white text-green-600 px-4 py-2 rounded-lg hover:bg-gray-100 transition flex items-center gap-2">
...
<div class="container mx-auto p-8 max-w-6xl">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <?php foreach ($schedules as $sched): ?>
                    ...
                    ?> p-4 rounded-r-lg">
                        <div class="flex justify-between items-start">
                            ...
                            <a href="viewSchedule.php?id=<?= $sched['schedule_id'] ?>" 
        ...
        <?php else: ?>
            <div class="text-center py-12 bg-gray-50 rounded-lg">
                ...
                <a href="manageSchedules.php" class="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 mt-6">
        ...
        <div class="flex gap-3">
            ...
            <button onclick="if(confirm('Delete this thesis group? This will also delete all related schedules!')) window.location.href='deleteGroup.php?id=<?= $group_id ?>'" 
