    ...
    <main class="flex-1 ml-64 p-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow-lg rounded-2xl p-6">
                ...
                <div class="space-y-3">
                  <a href="addFaculty.php" class="menu-link">
    <i data-lucide="users"></i>
    Manage Panelists
</a>
                    <a href="manageGroups.php" class="flex items-center gap-3 p-3 bg-green-50 rounded-lg hover:bg-green-100 transition">
                        <i data-lucide="users" class="w-5 h-5 text-green-600"></i>
                        <span class="font-medium text-gray-700">Create Thesis Group</span>
                    </a>
                    <a href="manageSchedules.php" class="flex items-center gap-3 p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
