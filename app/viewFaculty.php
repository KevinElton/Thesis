...
<!-- Sidebar -->
<?php include 'sidebar.php'; // Ensure sidebar.php exists and includes necessary navigation ?>
...
<main class="flex-1 ml-64 p-6 md:p-10"> <!-- Added responsive padding -->
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <a href="addFaculty.php" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center gap-1 shadow-md transition whitespace-nowrap">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-center text-sm">
                                <div class="inline-flex items-center gap-3">
                                    <a href="editFaculty.php?id=<?= $pid ?>" class="text-blue-600 hover:text-blue-900" title="Edit">
                                        <i data-lucide="edit-2" class="w-4 h-4"></i>
                                    </a>
                                    <a href="deleteFaculty.php?id=<?= $pid ?>" class="text-red-600 hover:text-red-900"
                                       title="Delete"
